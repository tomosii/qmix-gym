...
from gym_env.wrappers.monitoring import stats_recorder
...
class Monitor(MO):
    ...
    def _start(
        ...
        Args:
            ...
            indicating whether we should record a video on this episode.
            The default (for video_callable is None) is to take perfect cubes, capped at 1000. False disables video recording.
